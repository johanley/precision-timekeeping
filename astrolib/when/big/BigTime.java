...
public final class BigTime implements Comparable<BigTime> {
  ...
  */
  public static BigTime from(int hour, int minute, BigDecimal seconds, BigTimescale timescale) {
    return new BigTime(hour, minute, seconds, timescale);
  }
  ...
  */
  public static BigTime from(BigDecimal fraction, BigTimescale timescale) {
    return new BigTime(fraction, timescale);
  }
  
  /** Midnight 00:00:00 in the given timescale. */
  public static BigTime zero(BigTimescale timescale) {
    return new BigTime(0, 0, BigDecimal.ZERO, timescale);
  }
  ...
  @Override public boolean equals(Object aThat) {
    ...
    if (!(aThat instanceof BigTime)) return false;
    BigTime that = (BigTime)aThat;
  ...
  @Override public int compareTo(BigTime that) {
  ...
  private BigTime(int hour, int minute, BigDecimal seconds, BigTimescale timescale) {
    init(hour, minute, seconds, timescale);
  }
  
  private BigTime(BigDecimal fraction, BigTimescale timescale) {
  ...
  private void init(int hour, int minute, BigDecimal seconds, BigTimescale timescale) {
