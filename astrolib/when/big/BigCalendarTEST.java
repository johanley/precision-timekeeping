...
public class BigCalendarTEST {
  ...
  @Test public void cycleSize() {
    assertEquals(4, BigCalendar.JULIAN.fullCycleYears());
    assertEquals(1461, BigCalendar.JULIAN.fullCycleDays());
    assertEquals(400, BigCalendar.GREGORIAN.fullCycleYears());
  }
  ...
  private void testDaysFromDec32(int year, int month, double day, BigCalendar calendar, int expected) {
